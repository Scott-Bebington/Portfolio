        ...
        children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: desktopVariables.BodyTextSize, color: primaryColor),
                  ),
                ],
              ),
              SizedBox(width: 20),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(sendText, style: TextStyle(color: Colors.white, fontSize: desktopVariables.BodyTextSize)),
            ),
          ),
        ],
      ),
