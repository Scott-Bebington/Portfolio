...
class _DesktopServicesState extends State<DesktopServices> with SingleTickerProviderStateMixin {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 20),
          Text("Services i offer", style: TextStyle(fontSize: desktopVariables.SubHeadingTextSize, fontWeight: FontWeight.bold, color: primaryColor)),
          Wrap(
            spacing: 20,
            runSpacing: 20,
            ...
            children: [
              PaymentCard(
                ...
                dbIncluded: false,
                paymentIncluded: FollowPathEffect.defaultRotate,
                costStart: 5000,
                costEnd: 15000,
              ),
              PaymentCard(
...
class _PaymentCardState extends State<PaymentCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 300,
      height: 350, // Adjusted height based on expansion state
      decoration: BoxDecoration(
        color: Colors.white,
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20),
                        Text("Custom Design", style: TextStyle(fontSize: desktopVariables.cardBodyTextSize, color: Colors.grey)),
                      ],
                    ),
                  ),
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20),
                        Text("Website Creation", style: TextStyle(fontSize: desktopVariables.cardBodyTextSize, color: Colors.grey)),
                      ],
                    ),
                  ),
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20),
                        Text("Database Services", style: TextStyle(fontSize: desktopVariables.cardBodyTextSize, color: Colors.grey)),
                      ],
                    ),
                  ),
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20),
                        Text("Payment Services", style: TextStyle(fontSize: desktopVariables.cardBodyTextSize, color: Colors.grey)),
                      ],
                    ),
                  ),
                  SizedBox(
                ...
                children: [
                  Center(
                    child: Text(
                      widget.cardName,
                      style: TextStyle(
                        fontSize: desktopVariables.cardHeadingTextSize,
                        color: Colors.white,
                      ),
                    ),
                  ),
